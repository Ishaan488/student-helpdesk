...
from app.api.v1.endpoints import auth, companies, drives, students, chat, knowledge, escalation
...
v1_router.include_router(escalation.router, prefix="/escalations", tags=["Escalations"])
